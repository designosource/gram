...
class DashboardPlugin extends BasePlugin
{
    ...
    {
        return Craft::t('This plugin allows you to leave a message on the dashboard.');
    }
    ...
    {
        return 'https://github.com/https://github.com/designosource//dashboard/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/https://github.com/designosource//dashboard/master/releases.json';
    }
    ...
    {
        return 'http://www.designosource.be';
    }
